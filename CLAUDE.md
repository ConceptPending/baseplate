...
- The kernel's authoritative home is now [`ConceptPending/statespec`](https://github.com/ConceptPending/statespec) (tag `statespec-v0.4.0`); the in-tree `app/statespec/` copy is frozen at v0.3.0 as part of this reference example. Kernel changes happen there, not here.
